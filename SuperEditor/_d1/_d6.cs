...
namespace FEPKBIPDOHCNNFAKLHKGGCCCPGMCNPGGOCGM
{
    ...
    internal class FILAHPFFCCPGDOEKEBPPCFJDBLCAKCPOBEHM
    {
        ...
        {
            _bi2.AddTheme(FILAHPFFCCPGDOEKEBPPCFJDBLCAKCPOBEHM.OCJCCBBKNNLIAJBPBMMFHLHIAJEAFBMOIOFM, FILAHPFFCCPGDOEKEBPPCFJDBLCAKCPOBEHM.CMPOPFLJBNNNHDELDGDDKDJONFFGEBIGEPDL);
