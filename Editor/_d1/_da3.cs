...
namespace _yj2
{
    ...
    internal class _CLR
    {
        ...
        static _CLR()
        {
            _bi2.AddTheme(_CLR._CLS, _CLR._yl6);
            _bi2._CBY++;
        }

        // Token: 0x04000865 RID: 2149
        private static string _yl6 = "VS Dark with VA X";
        ...
        internal static Theme _CLS = new Theme
        {
            ...
            namespaces = new Color32(byte.MaxValue, 215, 0, byte.MaxValue),
            methods = new Color32(byte.MaxValue, 128, 0, byte.MaxValue),
            fields = new Color32(189, 183, 107, byte.MaxValue),
            properties = new Color32(189, 183, 107, byte.MaxValue),
            events = new Color32(189, 183, 107, byte.MaxValue),
            parameters = new Color32(189, 183, 107, byte.MaxValue),
            variables = new Color32(189, 183, 107, byte.MaxValue),
