                    ...
                    if (!flag3)
                    {
                        ...
                        if (!flag4)
                        {
                            ...
                            IL_0A3D:
                                ...
                                bool flag51 = Event.current.type == EventType.MouseUp || (flag50 && Event.current.type == EventType.MouseUp && Event.current.button == 1) || (Event.current.type == EventType.MouseUp && Event.current.button == 0);
