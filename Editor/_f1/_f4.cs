...
namespace ODGL
{
    ...
    internal class _f4 : _fa7
    {
        ...
        internal _f4()
        {
            this.GMELKFIDPECJBLICICGNHOIAGAFIJDMJJOMA = new Color(0f, 0f, 0f, 0.15f);
            this.EFNHCKBJENNIOPGJMGDCEHPOBDGECCNBMFJI = new Color(0f, 0f, 0f, 0.05f);
        ...
        {
            this.NIFHLMLDBHNAEAFBKCIAMLIMIPMEKIKCNPDC = _f5.GetInstance().Get<bool>(HierarchySetting.ShowRowShading);
        ...
        internal override void Draw(GameObject gameObject, _fb5 objectList, Rect selectionRect, Rect curRect)
        {
            ...
            curRect.height = 1f;
            curRect.x = 0f;
            EditorGUI.DrawRect(curRect, this.GMELKFIDPECJBLICICGNHOIAGAFIJDMJJOMA);
            bool flag = this.NIFHLMLDBHNAEAFBKCIAMLIMIPMEKIKCNPDC && Mathf.FloorToInt((selectionRect.y - 4f) / 16f % 2f) == 0;
            if (flag)
            {
                ...
                EditorGUI.DrawRect(selectionRect, this.EFNHCKBJENNIOPGJMGDCEHPOBDGECCNBMFJI);
            }
        }

        // Token: 0x0400080E RID: 2062
        private Color GMELKFIDPECJBLICICGNHOIAGAFIJDMJJOMA;

        // Token: 0x0400080F RID: 2063
        private Color EFNHCKBJENNIOPGJMGDCEHPOBDGECCNBMFJI;

        // Token: 0x04000810 RID: 2064
        private bool NIFHLMLDBHNAEAFBKCIAMLIMIPMEKIKCNPDC;
    }
}
